...
const teamMembers = [
    ...
    { name: 'Member 4', role: 'Project Manager' },
    { name: 'Member 5', role: 'QA Tester' },
];
...
const Landing = () => {
    ...
    return (
        <div className="w-full font-sans">
            ...
            <section id="hero" className="min-h-screen bg-dark relative overflow-hidden flex items-center pt-16">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-8 max-w-4xl mx-auto">
                        {teamMembers.map((member, index) => (
                            <div key={index} className="flex flex-col items-center">
                                <div className="w-24 h-24 bg-card rounded-full flex items-center justify-center mb-4 text-2xl font-bold text-accent">
                                    {member.name.split(' ').map(w => w[0]).join('')}
                                </div>
                                <h3 className="font-bold text-text-dark text-sm uppercase tracking-wider">
                                    {member.name}
                                </h3>
