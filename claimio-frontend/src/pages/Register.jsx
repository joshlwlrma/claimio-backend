    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-landing-dark p-4 relative overflow-hidden font-sans">
            ...
            <div className="w-full max-w-[900px] min-h-[500px] flex flex-col md:flex-row rounded-[2rem] overflow-hidden shadow-2xl z-10 relative border border-landing-border">
                ...
                <div className="w-full md:w-[35%] bg-black p-12 flex flex-col justify-center items-center text-center relative z-10 border-r border-landing-border">
                    <h3 className="text-3xl font-extrabold text-white mb-6 tracking-wide">Welcome Back!</h3>
                    <p className="text-landing-gray text-sm leading-relaxed mb-10 px-2 max-w-[200px]">
                        Already have an account?<br />Sign in to check your reports<br />and claim updates.
                    </p>
                    <Link to="/login" className="bg-transparent border border-white text-white font-semibold text-sm px-10 py-3 rounded-xl hover:bg-white hover:text-black transition-colors uppercase tracking-widest">
                        SIGN IN
                    </Link>
                </div>

                {/* Right Side: Create Account */}
                <div className="w-full md:w-[65%] bg-landing-surface p-10 lg:p-14 flex flex-col justify-center items-center relative z-10">

                    <h2 className="text-[32px] font-extrabold text-white mb-3">Create Account</h2>
